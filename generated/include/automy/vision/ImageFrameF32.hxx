...
class AUTOMY_VISION_EXPORT ImageFrameF32 : public ::automy::vision::ImageFrame {
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0x96b32bbfb60ce4ecull;
...
void ImageFrameF32::accept_generic(T& _visitor) const {
	_visitor.template type_begin<ImageFrameF32>(8);
	...
	_visitor.template type_end<ImageFrameF32>(8);
}
