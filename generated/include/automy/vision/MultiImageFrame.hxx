...
#ifndef INCLUDE_automy_vision_MultiImageFrame_HXX_
#define INCLUDE_automy_vision_MultiImageFrame_HXX_
...
class AUTOMY_VISION_EXPORT MultiImageFrame : public ::automy::vision::ImageFrame {
public:
	
	std::vector<std::shared_ptr<const ::automy::vision::ImageFrame>> frames;
	...
	static constexpr uint64_t VNX_TYPE_ID = 0x93902e89b3c34432ull;
...
void MultiImageFrame::accept_generic(T& _visitor) const {
	_visitor.template type_begin<MultiImageFrame>(8);
	...
	_visitor.type_field("frames", 7); _visitor.accept(frames);
	_visitor.template type_end<MultiImageFrame>(8);
}
...
#endif // INCLUDE_automy_vision_MultiImageFrame_HXX_
