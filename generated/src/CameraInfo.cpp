...
const vnx::Hash64 CameraInfo::VNX_TYPE_HASH(0xc2a27ca3691c2ca9ull);
const vnx::Hash64 CameraInfo::VNX_CODE_HASH(0x19a9cb20b8f20cf9ull);
...
const vnx::TypeCode* CameraInfo::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0xc2a27ca3691c2ca9ull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> CameraInfo::create_type_code() {
	...
	type_code->name = "vision.CameraInfo";
	type_code->type_hash = vnx::Hash64(0xc2a27ca3691c2ca9ull);
	type_code->code_hash = vnx::Hash64(0x19a9cb20b8f20cf9ull);
...
void write(TypeOutput& out, const ::vision::CameraInfo& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::vision::CameraInfo>(out);
		vnx::write_class_header<::vision::CameraInfo>(out);
	}
