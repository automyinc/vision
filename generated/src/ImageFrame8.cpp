...
const vnx::Hash64 ImageFrame8::VNX_TYPE_HASH(0xc8c351b0ccb3380ull);
const vnx::Hash64 ImageFrame8::VNX_CODE_HASH(0x1eb8e3b55d0a3b77ull);
...
const vnx::TypeCode* ImageFrame8::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0xc8c351b0ccb3380ull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> ImageFrame8::create_type_code() {
	...
	type_code->name = "vision.ImageFrame8";
	type_code->type_hash = vnx::Hash64(0xc8c351b0ccb3380ull);
	type_code->code_hash = vnx::Hash64(0x1eb8e3b55d0a3b77ull);
...
void write(TypeOutput& out, const ::vision::ImageFrame8& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::vision::ImageFrame8>(out);
		vnx::write_class_header<::vision::ImageFrame8>(out);
	}
