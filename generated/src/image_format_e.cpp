...
const vnx::Hash64 image_format_e::VNX_CODE_HASH(0x5e76203aed2dab2dull);
...
const vnx::TypeCode* image_format_e::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0xa4dcf5950509a49dull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> image_format_e::create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x5e76203aed2dab2dull);
...
void write(TypeOutput& out, const ::automy::vision::image_format_e& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::automy::vision::image_format_e>(out);
