...
const vnx::Hash64 ImageFrameF32::VNX_TYPE_HASH(0x88c89dfa6cb8d95dull);
const vnx::Hash64 ImageFrameF32::VNX_CODE_HASH(0x1a8c626e0ca9158ull);
...
const vnx::TypeCode* ImageFrameF32::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0x88c89dfa6cb8d95dull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> ImageFrameF32::create_type_code() {
	...
	type_code->name = "vision.ImageFrameF32";
	type_code->type_hash = vnx::Hash64(0x88c89dfa6cb8d95dull);
	type_code->code_hash = vnx::Hash64(0x1a8c626e0ca9158ull);
...
void write(TypeOutput& out, const ::vision::ImageFrameF32& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::vision::ImageFrameF32>(out);
		vnx::write_class_header<::vision::ImageFrameF32>(out);
	}
