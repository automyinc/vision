...
const vnx::Hash64 MultiImageFrame::VNX_TYPE_HASH(0x8ebd5fb50e1c20cdull);
const vnx::Hash64 MultiImageFrame::VNX_CODE_HASH(0xfe3f0ee4b105706full);
...
void MultiImageFrame::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[3], 3); vnx::accept(_visitor, frames);
...
const vnx::TypeCode* MultiImageFrame::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0x8ebd5fb50e1c20cdull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> MultiImageFrame::create_type_code() {
	...
	type_code->name = "vision.MultiImageFrame";
	type_code->type_hash = vnx::Hash64(0x8ebd5fb50e1c20cdull);
	type_code->code_hash = vnx::Hash64(0xfe3f0ee4b105706full);
...
void read(TypeInput& in, ::vision::MultiImageFrame& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const vnx::TypeField* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 3: vnx::read(in, value.frames, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::vision::MultiImageFrame& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::vision::MultiImageFrame>(out);
		vnx::write_class_header<::vision::MultiImageFrame>(out);
	}
	...
	vnx::write(out, value.frames, type_code, type_code->fields[3].code.data());
}
